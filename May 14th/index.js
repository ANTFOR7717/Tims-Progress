const userEntryArray = ["3M", "Amazon.com", "Disney", "Time Warner"];
...
// ***property is ARRAY in parameters??


// Make a function that accepts a stocks name and returns it's initial price
...
const getPrice = (companyName) => {
    ...
    let findParams = findByKey('company', companyName)
    let index = stockData.findIndex(findParams) 
    

return stockData[index].initial_price;

};
// console.log(getPrice("3M"));

//

// Make a function that accepts a stocks name and returns a description


const getDescription = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
return stockData[index].description;

};

// console.log(getDescription("COMPANY NAME"));

//

// Make a function that returns all available companies
...
const getAllNames = () => { 
    ...
    let allNamesLoop = [];
        ...
        allNamesLoop.push(stockData[property].company);
...
// Make a function that takes a stocks name and returns it's latest price

const getLatestPrice = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
return stockData[index].price_2007;

};

// console.log(getLatestPrice("COMPANY NAME"));

//

// Make a function that takes a stocks name and returns it's oldest price

const getOldestPrice = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
return stockData[index].price_2002;

};

// console.log(getOldestPrice("COMPANY NAME"));


// Make a function that takes a stocks name and shows a combined price of old and latest

const getCombinedPrice = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
return stockData[index].price_2002 + stockData[index].price_2007;

};

// console.log(getCombinedPrice("NAME"));


// Make a function that takes a stocks name and predicts a random/potential future price

const getPotentialPrice = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
return getRandomInt(10) *  stockData[index].price_2007;

};

// console.log(getPotentialPrice("COMPANY NAME"));

// Make a function that takes multiple stocks names and returns the all the details of those stocks... cleanly

const getCleanInfo = (companyName) => {
    function findByKey(key, value) {
        return (item) => item[key] === value
    }
...
//console.log(companyData);
    ...
    while (i < userEntryArray.length) {
        companyData.push((stockData[stockData.findIndex(  findByKey ('company', userEntryArray[i]))]));

        //console.log(userEntryArray[i]);
      // console.log(stockData[stockData.findIndex(  findByKey ('company', userEntryArray[i]))])
       // console.log(stockData.findIndex(  findByKey ('company', userEntryArray[i]))) 
       // results in Array placement of given companies in "userEntryAray" = number
        i++;
...
console.log(getCleanInfo(userEntryArray));


// Assume we are given ARRAYS. also PARAMETERS.     const userEntryArray = ["3M", "Amazon.com", "Disney", "Time Warner"];
